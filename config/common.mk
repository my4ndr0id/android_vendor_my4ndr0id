...
ifneq ($(TARGET_BOOTANIMATION_NAME),)
    PRODUCT_COPY_FILES += \
        vendor/my4ndr0id/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
...
PRODUCT_COPY_FILES += \
    vendor/my4ndr0id/CHANGELOG.mkdn:system/etc/CHANGELOG-CM.txt
